...
def random_ex():
    ...
    print(random.randrange(101))    # 0 ~ 100사이의 난수
    print(random.randrange(1, 101,3))   # 1 ~ 100사이의 3간격 수 중에서 난수

    # 순차형에 무작위성을 추가하는 부가 기능들
    seqvar = ["짬뽕", "짜장명", "짬짜면", "마라탕"]
    print("seqvar:", seqvar)
